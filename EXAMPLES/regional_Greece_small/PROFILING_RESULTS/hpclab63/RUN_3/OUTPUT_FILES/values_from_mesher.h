 ...
 !
 ! maximum number of points per region =      2959857
 !
 ! on NEC SX, make sure "loopcnt=" parameter
 ! in Makefile is greater than max vector length =      8879571
 !
 ! total elements per slice =        49728
 ! total points per slice =      3274255
 !
 ...
 !
 ! size of static arrays per slice =    1945.6881200000000       MB
 !                                 =    1855.5527877807617       MiB
 !                                 =    1.9456881200000000       GB
 !                                 =    1.8120632693171501       GiB
 !
 ...
 !
 ! size of static arrays for all slices =    1945.6881200000000       MB
 !                                      =    1855.5527877807617       MiB
 !                                      =    1.9456881200000000       GB
 !                                      =    1.8120632693171501       GiB
 !                                      =    1.9456881200000001E-003  TB
 !                                      =    1.7695930364425294E-003  TiB
 !

 integer, parameter :: NEX_XI_VAL =           64
 integer, parameter :: NEX_ETA_VAL =           64

 integer, parameter :: NSPEC_CRUST_MANTLE =        45056
 integer, parameter :: NSPEC_OUTER_CORE =         4480
 integer, parameter :: NSPEC_INNER_CORE =          192

 integer, parameter :: NGLOB_CRUST_MANTLE =      2959857
 integer, parameter :: NGLOB_OUTER_CORE =       300241
 integer, parameter :: NGLOB_INNER_CORE =        14157

 integer, parameter :: NSPECMAX_ANISO_IC =            1

 integer, parameter :: NSPECMAX_ISO_MANTLE =        45056
 integer, parameter :: NSPECMAX_TISO_MANTLE =        45056
 integer, parameter :: NSPECMAX_ANISO_MANTLE =            1

 integer, parameter :: NSPEC_CRUST_MANTLE_ATTENUATION =        45056
 integer, parameter :: NSPEC_INNER_CORE_ATTENUATION =          192

 integer, parameter :: NSPEC_CRUST_MANTLE_STR_OR_ATT =        45056
 integer, parameter :: NSPEC_INNER_CORE_STR_OR_ATT =          192
 ...
 integer, parameter :: NSPEC_CRUST_MANTLE_STACEY =        45056
 integer, parameter :: NSPEC_OUTER_CORE_STACEY =         4480

 integer, parameter :: NGLOB_CRUST_MANTLE_OCEANS =      2959857
 ...
 integer, parameter :: NSPEC_OUTER_CORE_ROTATION =         4480
 ...
 integer, parameter :: ATT4_VAL =        45056
 integer, parameter :: ATT5_VAL =          192

 integer, parameter :: NSPEC2DMAX_XMIN_XMAX_CM =         1280
 integer, parameter :: NSPEC2DMAX_YMIN_YMAX_CM =         1280
 integer, parameter :: NSPEC2D_BOTTOM_CM =          256
 integer, parameter :: NSPEC2D_TOP_CM =         4096
 integer, parameter :: NSPEC2DMAX_XMIN_XMAX_IC =           24
 integer, parameter :: NSPEC2DMAX_YMIN_YMAX_IC =           24
 integer, parameter :: NSPEC2D_BOTTOM_IC =           64
 integer, parameter :: NSPEC2D_TOP_IC =           64
 integer, parameter :: NSPEC2DMAX_XMIN_XMAX_OC =          336
 integer, parameter :: NSPEC2DMAX_YMIN_YMAX_OC =          336
 integer, parameter :: NSPEC2D_BOTTOM_OC =           64
 integer, parameter :: NSPEC2D_TOP_OC =          256
 ...
 integer, parameter :: NGLOB_XY_CM =      2959857
 ...
 integer, parameter :: NT_DUMP_ATTENUATION_VAL =           17
