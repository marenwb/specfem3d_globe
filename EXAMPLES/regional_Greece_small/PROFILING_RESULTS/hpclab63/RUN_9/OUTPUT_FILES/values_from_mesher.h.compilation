 ...
 !
 ! maximum number of points per region =      8866533
 !
 ! on NEC SX, make sure "loopcnt=" parameter
 ! in Makefile is greater than max vector length =     26599599
 !
 ! total elements per slice =       151488
 ! total points per slice =      9896471
 !
 ! the time step of the solver will be DT =    8.45284313E-02  (s)
 ! the (approximate) minimum period resolved will be =    10.0740738      (s)
 !
 ...
 ! latitude in degrees =    49.192981807843729     
 !
 ! corner            4
 ...
 ! -------------------------------------
 !
 ! spectral elements along a great circle =         1728
 ! GLL points along a great circle =         6912
 ! average distance between points in degrees =    5.20833321E-02
 ! average distance between points in km =    5.79140234    
 ! average size of a spectral element in km =    23.1656094    
 !
 ...
 !
 ! size of static arrays per slice =    5755.7196560000002       MB
 !                                 =    5489.0820083618164       MiB
 !                                 =    5.7557196560000001       GB
 !                                 =    5.3604316487908363       GiB
 !
 ...
 !
 ! size of static arrays for all slices =    5755.7196560000002       MB
 !                                      =    5489.0820083618164       MiB
 !                                      =    5.7557196560000001       GB
 !                                      =    5.3604316487908363       GiB
 !                                      =    5.7557196560000003E-003  TB
 !                                      =    5.2347965320223011E-003  TiB
 !

 integer, parameter :: NEX_XI_VAL =           96
 integer, parameter :: NEX_ETA_VAL =           96

 integer, parameter :: NSPEC_CRUST_MANTLE =       135936
 integer, parameter :: NSPEC_OUTER_CORE =        14688
 integer, parameter :: NSPEC_INNER_CORE =          864

 integer, parameter :: NGLOB_CRUST_MANTLE =      8866533
 integer, parameter :: NGLOB_OUTER_CORE =       969913
 integer, parameter :: NGLOB_INNER_CORE =        60025

 integer, parameter :: NSPECMAX_ANISO_IC =            1

 integer, parameter :: NSPECMAX_ISO_MANTLE =       135936
 integer, parameter :: NSPECMAX_TISO_MANTLE =       135936
 integer, parameter :: NSPECMAX_ANISO_MANTLE =            1

 integer, parameter :: NSPEC_CRUST_MANTLE_ATTENUATION =       135936
 integer, parameter :: NSPEC_INNER_CORE_ATTENUATION =          864

 integer, parameter :: NSPEC_CRUST_MANTLE_STR_OR_ATT =       135936
 integer, parameter :: NSPEC_INNER_CORE_STR_OR_ATT =          864
 ...
 integer, parameter :: NSPEC_CRUST_MANTLE_STACEY =       135936
 integer, parameter :: NSPEC_OUTER_CORE_STACEY =        14688

 integer, parameter :: NGLOB_CRUST_MANTLE_OCEANS =      8866533
 ...
 integer, parameter :: NSPEC_OUTER_CORE_ROTATION =        14688
 ...
 integer, parameter :: ATT4_VAL =       135936
 integer, parameter :: ATT5_VAL =          864

 integer, parameter :: NSPEC2DMAX_XMIN_XMAX_CM =         2736
 integer, parameter :: NSPEC2DMAX_YMIN_YMAX_CM =         2736
 integer, parameter :: NSPEC2D_BOTTOM_CM =          576
 integer, parameter :: NSPEC2D_TOP_CM =         9216
 integer, parameter :: NSPEC2DMAX_XMIN_XMAX_IC =           72
 integer, parameter :: NSPEC2DMAX_YMIN_YMAX_IC =           72
 integer, parameter :: NSPEC2D_BOTTOM_IC =          144
 integer, parameter :: NSPEC2D_TOP_IC =          144
 integer, parameter :: NSPEC2DMAX_XMIN_XMAX_OC =          744
 integer, parameter :: NSPEC2DMAX_YMIN_YMAX_OC =          744
 integer, parameter :: NSPEC2D_BOTTOM_OC =          144
 integer, parameter :: NSPEC2D_TOP_OC =          576
 ...
 integer, parameter :: NGLOB_XY_CM =      8866533
 ...
 integer, parameter :: NT_DUMP_ATTENUATION_VAL =          -41
