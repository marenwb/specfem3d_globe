 ...
 !
 ! maximum number of points per region =      5442541
 !
 ! on NEC SX, make sure "loopcnt=" parameter
 ! in Makefile is greater than max vector length =     16327623
 !
 ! total elements per slice =        92300
 ! total points per slice =      6049143
 !
 ! the time step of the solver will be DT =   0.101434119      (s)
 ! the (approximate) minimum period resolved will be =    12.0888891      (s)
 !
 ...
 ! average distance between points in degrees =    6.25000000E-02
 ...
 !
 ! size of static arrays per slice =    3542.8974159999998       MB
 !                                 =    3378.7702713012695       MiB
 !                                 =    3.5428974160000002       GB
 !                                 =    3.2995803430676460       GiB
 !
 ...
 !
 ! size of static arrays for all slices =    3542.8974159999998       MB
 !                                      =    3378.7702713012695       MiB
 !                                      =    3.5428974160000002       GB
 !                                      =    3.2995803430676460       GiB
 !                                      =    3.5428974159999998E-003  TB
 !                                      =    3.2222464287769981E-003  TiB
 !

 integer, parameter :: NEX_XI_VAL =           80
 integer, parameter :: NEX_ETA_VAL =           80

 integer, parameter :: NSPEC_CRUST_MANTLE =        83200
 integer, parameter :: NSPEC_OUTER_CORE =         8700
 integer, parameter :: NSPEC_INNER_CORE =          400

 integer, parameter :: NGLOB_CRUST_MANTLE =      5442541
 integer, parameter :: NGLOB_OUTER_CORE =       578025
 integer, parameter :: NGLOB_INNER_CORE =        28577

 integer, parameter :: NSPECMAX_ANISO_IC =            1

 integer, parameter :: NSPECMAX_ISO_MANTLE =        83200
 integer, parameter :: NSPECMAX_TISO_MANTLE =        83200
 integer, parameter :: NSPECMAX_ANISO_MANTLE =            1

 integer, parameter :: NSPEC_CRUST_MANTLE_ATTENUATION =        83200
 integer, parameter :: NSPEC_INNER_CORE_ATTENUATION =          400

 integer, parameter :: NSPEC_CRUST_MANTLE_STR_OR_ATT =        83200
 integer, parameter :: NSPEC_INNER_CORE_STR_OR_ATT =          400
 ...
 integer, parameter :: NSPEC_CRUST_MANTLE_STACEY =        83200
 integer, parameter :: NSPEC_OUTER_CORE_STACEY =         8700

 integer, parameter :: NGLOB_CRUST_MANTLE_OCEANS =      5442541
 ...
 integer, parameter :: NSPEC_OUTER_CORE_ROTATION =         8700
 ...
 integer, parameter :: ATT4_VAL =        83200
 integer, parameter :: ATT5_VAL =          400

 integer, parameter :: NSPEC2DMAX_XMIN_XMAX_CM =         1960
 integer, parameter :: NSPEC2DMAX_YMIN_YMAX_CM =         1960
 integer, parameter :: NSPEC2D_BOTTOM_CM =          400
 integer, parameter :: NSPEC2D_TOP_CM =         6400
 integer, parameter :: NSPEC2DMAX_XMIN_XMAX_IC =           40
 integer, parameter :: NSPEC2DMAX_YMIN_YMAX_IC =           40
 integer, parameter :: NSPEC2D_BOTTOM_IC =          100
 integer, parameter :: NSPEC2D_TOP_IC =          100
 integer, parameter :: NSPEC2DMAX_XMIN_XMAX_OC =          530
 integer, parameter :: NSPEC2DMAX_YMIN_YMAX_OC =          530
 integer, parameter :: NSPEC2D_BOTTOM_OC =          100
 integer, parameter :: NSPEC2D_TOP_OC =          400
 ...
 integer, parameter :: NGLOB_XY_CM =      5442541
 ...
 integer, parameter :: NT_DUMP_ATTENUATION_VAL =          -22
